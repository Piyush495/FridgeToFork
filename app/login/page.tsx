    ...
    <div className="w-full max-w-[440px] bg-white p-6 sm:p-10 rounded-[28px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#2D6A4F]/10 lg:mt-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex justify-end pt-1">
          <Link href="#" className="text-xs sm:text-sm text-[#2D6A4F] font-semibold hover:underline">
            Forgot password?
          </Link>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-[#2D6A4F] hover:bg-[#1e5038] text-white font-medium py-3.5 px-4 rounded-xl text-sm transition shadow-lg shadow-[#2D6A4F]/20 flex items-center justify-center gap-2 hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0"
        >
